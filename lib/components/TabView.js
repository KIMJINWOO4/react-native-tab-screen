...
var TabView = function (_a) {
    ...
    var renderTabBar = function () { return (react_1.default.createElement(react_native_1.View, { style: defaultStyles_1.default.tabContainer }, tabs.map(function (tab, index) { return (react_1.default.createElement(react_native_1.TouchableOpacity, { key: index, style: [defaultStyles_1.default.tab, inactiveTabStyle, activeTab === index && [defaultStyles_1.default.activeTab, activeTabStyle]], onPress: function () { return handleTabPress(index); } },
